    ...
    <Container maxW="container.lg" mt={6}>
      <VStack spacing={4} alignItems="flex-start">
        ...
        <Text as="p">
          ...
          Click the "Set up your profile" button in the bottom left corner of
          the page or you can click{" "}
        ...
        <Text as="p">
          ...
          data from your actual FPL team. However, due to a technical
          limitation, that we cannot pull your team data before FPL makes it
          public so your team will be synced only the morning after the current
          gameweek deadline has passed.
        </Text>
        <Text as="p">
          Each player is respresented by a card. The anatomy of the player card
          is almost the same as described in{" "}
      ...
      <VStack spacing={4} alignItems="flex-start">
        ...
        <Text as="p">
          ...
          usage on the top toolbar. You can also navigate through future
        ...
        <Text as="p">
          ...
          changelog. You see all transactions being made in each gameweek and
          you can remove each one of them if you wish to undo your action.
        </Text>
        ...
        <Text as="p">
          ...
          the top of screen. You can rearrange the tab by dragging them around.
          You can also rename or remove it by clicking{" "}
        ...
        <Text as="p">
          ...
          is hard to say how many plans you can have. Generally, any up-to-date
          browsers should be able to handle up to 10 plans.
        </Text>
